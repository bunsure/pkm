...
<div class="m-content">
	...
	<div class="m-portlet">
		...
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-berita','backend/halaman-berita/update')}}
					{{ Form::bsHidden('uuid', $berita->uuid)}}
					{{ Form::bsText('judul','Judul Berita',$berita->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi Berita',$berita->isi,true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',$berita->tgl_posting,true,'') }}
					<hr>
					<div class="row">
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$berita->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
