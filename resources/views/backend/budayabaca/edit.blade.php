		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Edit Budaya Baca</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-budayabaca','backend/halaman-budayabaca/update')}}
					{{ Form::bsHidden('uuid', $budayabaca->uuid)}}
					{{ Form::bsText('judul','Judul Budaya Baca',$budayabaca->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi Budaya Baca',$budayabaca->isi,true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',$budayabaca->tgl_posting,true,'') }}
					<hr>
					<div class="row">
...
@section("modal")
	@if(ucc())
	{{Html::bsFormModalOpen('form-upload-gambar','Upload Gambar','backend/halaman-budayabaca/upload-gambar')}}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$budayabaca->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
