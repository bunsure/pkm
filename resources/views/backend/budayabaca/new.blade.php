		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Budaya Baca Baru</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-budayabaca','backend/halaman-budayabaca/insert')}}
					{{ Form::bsText('judul','Judul Budaya Baca','',true,'') }}
					{{ Form::bsTextarea('isi','Isi Budaya Baca','',true,'') }}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.Session::get('session_upload_gambar_budayabaca'))}}");
	}
	$(function(){
		reload_list_gambar();
