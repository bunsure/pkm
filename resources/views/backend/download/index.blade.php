		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Halaman Download</h3>
				</div>
			</div>
		</div>
...
@section("modal")
	 @if(ucc())
	{{Html::bsFormModalOpen('form-tambah-dokumen','Upload Dokumen','backend/download/insert')}}
	...
	@if(ucu())
	{{Html::bsFormModalOpen('form-edit-dokumen','Ubah Nama Dokumen','backend/download/update')}}
		{{ Form::bsText('nama','Nama Dokumen','',true,'') }}
	...
	@if(ucd())
	{{Html::bsFormModalOpen('form-hapus-dokumen','Hapus Dokumen','backend/download/delete')}}
...
<script type="text/javascript">
	$(function(){
		...
		?>
		{{Html::jsDatatable('tabel1',$field,url('backend/download/dt'),10)}}
		...
		{{Html::jsModalShow('modal-form-edit-dokumen')}}
			...
			$.get("{{url('backend/download/get')}}/"+$id_dokumen, function($data){
