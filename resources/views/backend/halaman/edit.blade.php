		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Edit Halaman</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-halaman','backend/halaman-statis/update')}}
					{{ Form::bsHidden('uuid', $halaman->uuid)}}
					{{ Form::bsText('judul','Judul',$halaman->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi',$halaman->isi,true,'') }}
					<hr>
					<div class="row">
...
@section("modal")
	@if(ucc())
	{{Html::bsFormModalOpen('form-upload-gambar','Upload Gambar','backend/halaman-statis/upload-gambar')}}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$halaman->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
