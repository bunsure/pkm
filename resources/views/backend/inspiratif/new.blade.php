		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Sosok Inspiratif Baru</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-inspiratif','backend/halaman-inspiratif/insert')}}
					{{ Form::bsText('judul','Judul Sosok Inpiratif','',true,'') }}
					{{ Form::bsTextarea('isi','Isi Sosok Inspiratif','',true,'') }}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.Session::get('session_upload_gambar_inspiratif'))}}");
	}
	$(function(){
		reload_list_gambar();
