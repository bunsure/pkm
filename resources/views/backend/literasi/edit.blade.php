		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Edit Literasi</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-literasi','backend/halaman-literasi/update')}}
					{{ Form::bsHidden('uuid', $literasi->uuid)}}
					{{ Form::bsText('judul','Judul Literasi',$literasi->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi Literasi',$literasi->isi,true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',$literasi->tgl_posting,true,'') }}
					<hr>
					<div class="row">
...
@section("modal")
	@if(ucc())
	{{Html::bsFormModalOpen('form-upload-gambar','Upload Gambar','backend/halaman-literasi/upload-gambar')}}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$literasi->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
