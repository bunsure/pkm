		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Literasi Baru</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-literasi','backend/halaman-literasi/insert')}}
					{{ Form::bsText('judul','Judul Literasi','',true,'') }}
					{{ Form::bsTextarea('isi','Isi Literasi','',true,'') }}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.Session::get('session_upload_gambar_literasi'))}}");
	}
	$(function(){
		reload_list_gambar();
