...
<div class="m-content">
	...
	<div class="m-portlet">
		...
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-loker','backend/loker/update')}}
					{{ Form::bsHidden('uuid', $loker->uuid)}}
					{{ Form::bsText('judul','Lowongan Kerja',$loker->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi Lowongan Kerja',$loker->isi,true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',$loker->tgl_posting,true,'') }}
					<hr>
					<div class="row">
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$loker->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
