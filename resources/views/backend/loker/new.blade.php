		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Lowongan Kerja Baru</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-loker','backend/loker/insert')}}
					{{ Form::bsText('judul','Lowongan Kerja','',true,'') }}
					{{ Form::bsTextarea('isi','Isi Lowongan Kerja','',true,'') }}
...
@section("modal")
	@if(ucc())
	{{Html::bsFormModalOpen('form-upload-gambar','Upload Gambar','backend/loker/upload-gambar')}}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.Session::get('session_upload_gambar_loker'))}}");
	}
	$(function(){
		reload_list_gambar();
