...
<div class="m-content">
	...
	<div class="m-portlet">
		...
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-manajemen','backend/halaman-manajemen/update')}}
					{{ Form::bsHidden('uuid', $manajemen->uuid)}}
					{{ Form::bsText('judul','Judul Budaya Baca',$manajemen->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi Budaya Baca',$manajemen->isi,true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',$manajemen->tgl_posting,true,'') }}
					<hr>
					<div class="row">
...
@section("modal")
	@if(ucc())
	{{Html::bsFormModalOpen('form-upload-gambar','Upload Gambar','backend/halaman-manajemen/upload-gambar')}}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$manajemen->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
