		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Manajemen Sekolah Baru</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-manajemen','backend/halaman-manajemen/insert')}}
					{{ Form::bsText('judul','Judul Manajemen Sekolah','',true,'') }}
					{{ Form::bsTextarea('isi','Isi Manajemen Sekolah','',true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',date('Y-m-d'),true,'') }}
					<hr>
					<div class="row">
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.Session::get('session_upload_gambar_manajemen'))}}");
	}
	$(function(){
		reload_list_gambar();
