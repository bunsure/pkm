		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Edit Parenting</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-parenting','backend/halaman-parenting/update')}}
					{{ Form::bsHidden('uuid', $parenting->uuid)}}
					{{ Form::bsText('judul','Judul Parenting',$parenting->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi Parenting',$parenting->isi,true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',$parenting->tgl_posting,true,'') }}
					<hr>
					<div class="row">
...
@section("modal")
	@if(ucc())
	{{Html::bsFormModalOpen('form-upload-gambar','Upload Gambar','backend/halaman-parenting/upload-gambar')}}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$parenting->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
