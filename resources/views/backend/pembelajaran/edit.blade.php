		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Edit Pembelajaran</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-pembelajaran','backend/halaman-pembelajaran/update')}}
					{{ Form::bsHidden('uuid', $pembelajaran->uuid)}}
					{{ Form::bsText('judul','Judul Pembelajaran',$pembelajaran->judul,true,'') }}
					{{ Form::bsTextarea('isi','Isi Pembelajaran',$pembelajaran->isi,true,'') }}
					{{ Form::bsText('tgl_posting','Tanggal Posting',$pembelajaran->tgl_posting,true,'') }}
					<hr>
					<div class="row">
...
@section("modal")
	@if(ucc())
	{{Html::bsFormModalOpen('form-upload-gambar','Upload Gambar','backend/halaman-pembelajaran/upload-gambar')}}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.$pembelajaran->uuid)}}");
	}
	$(function(){
		reload_list_gambar();
