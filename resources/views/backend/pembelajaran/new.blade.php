		...
		<div class="m-portlet__head">
			<div class="m-portlet__head-caption">
				<div class="m-portlet__head-title">
					...
					<h3 class="m-portlet__head-text">Pembelajaran Baru</h3>
				</div>
			</div>
		</div>
		<div class="m-portlet__body">
			<div class="col-md-12">
				{{Html::bsForm('form-pembelajaran','backend/halaman-pembelajaran/insert')}}
					{{ Form::bsText('judul','Judul Pembelajaran','',true,'') }}
					{{ Form::bsTextarea('isi','Isi Pembelajaran','',true,'') }}
...
<script type="text/javascript">
	var reload_list_gambar = function(){
		$("#list-gambar").load("{{url('backend/list-gambar/session/'.Session::get('session_upload_gambar_pembelajaran'))}}");
	}
	$(function(){
		reload_list_gambar();
