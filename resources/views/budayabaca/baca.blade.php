...
$gambar =DB::table('gambar_budayabaca as a')
		...
		->where('id_budayabaca', $budayabaca->id_budayabaca)
...
@section('meta-share')
<meta property="og:title" content="{{$budayabaca->judul}}">
<meta property="og:description" content="{{$budayabaca->judul}}">
<meta property="og:image" content="{{$img}}">
<meta property="og:url" content="{{url('baca-budayabaca/'.$budayabaca->uuid)}}">
@endsection
		...
		<div class="blog-posts">
			<article class="post">
				<div class="post-content">
					<h2><a href="{{url('baca-budayabaca/'.$budayabaca->uuid)}}">
						{{$budayabaca->judul}}
					</a></h2>
					<div class="post-meta">
						<span><i class="fa fa-calendar"></i>
							{!! tgl_indo_singkat($budayabaca->tgl_posting) !!}
						</span>
						<span><i class="fa fa-user"></i> Dipublikasikan oleh {!! $budayabaca->create_by !!} </span>
					...
					<hr class="invisible short">
					<?php
					$gambar_budayabaca =  DB::table('gambar_budayabaca as a')
									->select('b.*')
									->join('gambar as b','b.id_gambar', '=','a.id_gambar')
									->where('id_budayabaca', $budayabaca->id_budayabaca)
									->orderby('id_gambar_budayabaca','asc')
									->get();
					?>
					@if(count($gambar_budayabaca)>1)
					<div class="row">
			    		@foreach($gambar_budayabaca as $g)
							<div class="col-md-4">
	...
	<div class="col-md-3">
		...
		<div class="tabs mb-xlg">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#recentPosts" data-toggle="tab">Budaya Baca Lainnya</a>
				</li>
			</ul>
