	...
	<div class="col-md-9">
		<div class="heading heading-primary heading-border heading-bottom-border" style="margin-bottom: 15px !important;"> 
		    <h4 class=heading-default>
		    	<a href="{{url('dokumen')}}">Dokumen <strong>Pembelajaran</strong>&nbsp;<i class="fa fa-caret-right"></i></a>
		    </h4> 
		</div> 
		<div class="blog-posts">
			<?php 
			 $current = $dokumen->currentPage();
			 $perpage = $dokumen->perPage();
			?>
			 <div class="col-,md-12">
			 	<table class="table table-condensed table-hover table-striped">
			 		<thead>
			 			<tr>
			 				<th width="5%">No.</th>
			 				<th width="85%">Nama Dokumen Pembelajaran</th>
