...
<div class="center">
	<h3>Website Resmi <strong> Dinas Tenaga Kerja dan Perindustrian </strong> Kabupaten Batang Hari<br></h3>
</div>
<hr>
	<div class="col-md-4">
		<h4 class="mt-sm" style="line-height:1.2em !important;"> Dinas Tenaga Kerja dan Perindustrian </h4>
...
<script>
  function initMap() {
	...
	var infowindow = new google.maps.InfoWindow({
	  content:"<center><strong>Dinas Tenaga Kerja dan Perindustrian Kabupaten Batang Hari</strong><br/>{!! config('instansi.alamat') !!} <br/><a href='https://www.google.com/maps/search/?api=1&query=-1.6000227,103.3792110' target='_blank'><i class='fa fa-location-arrow'></i> Lihat Petunjuk</a></center>"
	});
