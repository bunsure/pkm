	...
	<div class="col-md-9">
		<div class="heading heading-primary heading-border heading-bottom-border"> 
	        <h4 class=heading-default>
	        	<a href="{{url('list-inspiratif')}}" data-plugin-tooltip="" type="link" data-toggle="tooltip" data-placement="right" title="Lihat lainnya" data-original-title="Lihat lainnya">Sosok Inspiratif&nbsp;<i class="fa fa-caret-right"></i></a>
	        </h4> 
	    </div> 
		<div class="blog-posts">
			@foreach($inspiratif as $b)
				<?php
				$gambar =DB::table('gambar_inspiratif as a')
						->select('b.*')
						->join('gambar as b','b.id_gambar', '=','a.id_gambar')
						->where('id_inspiratif', $b->id_inspiratif)
					...
					<div class="row">
						...
						<div class="col-md-7">
							<div class="post-content">
								<h4>
									<a href="{{url('baca-inspiratif/'.$b->uuid)}}">
										{!! $b->judul !!}
									</a>
								</h4>
								<?php 
